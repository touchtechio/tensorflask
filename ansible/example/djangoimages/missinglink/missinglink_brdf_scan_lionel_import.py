...
path = './data/brdf_scan_lionel.csv'
...
def updateImageMaskTags(update_image):
    ...
    if "tfrecord_" in filename:
        update_image.tags.add("tfrecord_scan_lionel")


    if "marked_" in filename:
        update_image.tags.add("marked_scan_lionel")

    if "brdf_scan_lionel" in filename:
